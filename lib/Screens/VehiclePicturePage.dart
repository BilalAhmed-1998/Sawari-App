...
class VehiclePicturePage extends StatefulWidget {
  static const routeName =  '/VehiclePicturePage';
  @override
  VehiclePicturePageState createState() =>VehiclePicturePageState();
}

class VehiclePicturePageState extends State<VehiclePicturePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Vehicle Picture',
                ...
                Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      const Text('Add vehicle picture for verification', style:TextStyle(fontSize: 17, color: Colors.black87)),
                      const Padding(
