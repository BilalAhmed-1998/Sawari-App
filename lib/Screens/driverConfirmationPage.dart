...
class driverConfirmationPage extends StatefulWidget {
  static const routeName = '/driverConfirmationPage';
  ...
  driverConfirmationPage({this.pickupCoordinates,this.Name,this.Phone,this.rideId});
...
class _driverConfirmationPageState extends State<driverConfirmationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    maxChildSize: 0.2,
      ...
      await MapLauncher.showDirections(
        ...
        destination: Coords(widget.pickupCoordinates.latitude,widget.pickupCoordinates.longitude),
  ...
  Future<void> getPlaceDirection() async{
    ...
    initialPos = await _determinePosition();
    Position finalPos = Position(latitude: widget.pickupCoordinates.latitude,longitude: widget.pickupCoordinates.longitude);

    await dbMain.updateDriverInfo(widget.rideId,initialPos);


    updateMarkerAndCircle2(finalPos, imageData2);
    updateMarkerAndCircle(initialPos, imageData);


    var pickupLatlng = LatLng(initialPos.latitude, initialPos.longitude);
    var dropoffLatlng = LatLng(widget.pickupCoordinates.latitude, widget.pickupCoordinates.longitude);
